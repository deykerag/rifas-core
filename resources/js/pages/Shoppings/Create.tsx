...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Crear', href: '/shoppings/create' },
];

export default function ShoppingCreate({ raffles, paymentMethods }: { raffles: Raffle[], paymentMethods: PaymentMethod[] }) {
        ...
        <div className="max-w-4xl mx-auto w-full">
          <Card className="border-border/50 shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Detalles de la compra</CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <FormField control={form.control} name="voucher" render={({ field: { value, onChange, ...fieldProps } }) => (
                        <FormItem>
                          <FormLabel>Comprobante (Voucher)</FormLabel>
                          {previewUrl && (
                            <div className="mb-4 w-full aspect-[3/4] rounded-lg overflow-hidden border border-border bg-muted/30 flex items-center justify-center relative group mt-2">
                                <img 
                                    src={previewUrl} 
                                    alt="Voucher Preview" 
