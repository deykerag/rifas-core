                        ...
                        <FormItem>
                          ...
                          {shopping.voucher && (
                            <div className="mb-4 w-full aspect-[3/4] rounded-lg overflow-hidden border border-border bg-muted/30 flex items-center justify-center relative group mt-2">
                                <a href={`/storage/${shopping.voucher}`} target="_blank" className="w-full h-full block">
                                    <img 
                                        src={`/storage/${shopping.voucher}`} 
                                        alt="Voucher" 
                                        className="h-full w-full object-contain p-2 hover:opacity-90 transition-opacity" 
                                    />
                                </a>
                            </div>
                          )}
